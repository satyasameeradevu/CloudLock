const api = process.env.REACT_APP_CONTACTS_API_URL || 'http://localhost:8181'
...
export const uploadFile = (payload) =>
    ...
    export const searchFile = (searchString) =>
    fetch(`${api}/files/search?searchStr=`+searchString, {
        method: 'GET',
        credentials:'include'
    }).then(res => {
...
export const shareFile = (filedata) =>
    ...
    export const shareFileEncryption = (filedata) =>
    fetch(`${api}/files/sharefileEncryption`, {
        method: 'POST',
        headers: {
            ...headers,
            'Content-Type': 'application/json'
