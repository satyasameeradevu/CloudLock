...
class FileUpload extends Component {
    ...
    handleFileSearch = (event) => {
        ...
        //payload.append('data', event.target.value);
        ...
        .then((res) => {
            ...
            if (res.status == 200) {
                ...
                res.json().then(filedata => {
                    this.props.searchFile(filedata);
                });
...
console.log('dataaa..',data);
                        ...
                        this.setState({
                            ...
                            message: this.state.message+" File Shared Successfully!"
                        });
                        console.log("Success...")
                        ...
                        this.setState({
                            ...
                            message: this.state.message+" Error in file sharing. Please try later !"
                        });
                    }
                });
        }
                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                        ...
                        <FileGridList deleteFile={this.deleteFile}
                                      ...
                                      shareFileEncryption={this.shareFileEncryption}/>
                        <div className="col-sm-1 "></div>
