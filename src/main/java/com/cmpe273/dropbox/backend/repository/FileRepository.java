...
public interface FileRepository extends CrudRepository<Files, Long> {
    ...
    @Transactional
    @Modifying
    @Query("UPDATE Files f SET f.searchcount = :searchcount WHERE f.filepath = :filepath")
    void updateSearchCount(@Param("filepath") String filepath, @Param("searchcount") Integer searchcount );
